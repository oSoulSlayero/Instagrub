							...
							?>
								<div class="col-md-3">
									<div class="panel panel-default">
										<div class="panel-heading text-center"style= background:#FFDF00; width:100%>
											<b><?php echo $pfrow['productname']; ?></b>
										</div>
										<div class="panel-body"style= background:#FFF111; width:100%>
											<img src="<?php if(empty($pfrow['photo'])){echo "upload/noimage.jpg";} else{echo $pfrow['photo'];} ?>" height="225px;" width="100%">
										</div>
										<div class="panel-footer text-center"style= background:#FFAA00; width:100%>
